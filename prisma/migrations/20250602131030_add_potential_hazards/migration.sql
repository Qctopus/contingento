/*
  ...
  - Added the required column `potentialHazards` to the `RiskAssessment` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_RiskAssessment" ("hazards", "id", "planId") SELECT "hazards", "id", "planId" FROM "RiskAssessment";
