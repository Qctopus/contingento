...
export default function Admin2Page() {
  ...
  const TabButton = ({ tab, label }: { tab: MainTab; label: string }) => (
    <button
      ...
      className={`relative inline-flex items-center h-12 px-5 text-sm font-medium transition-colors duration-200 border-b-2 rounded-t-md focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white ${
        activeTab === tab
