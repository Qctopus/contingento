...
export function ParishOverview({ parishes, onParishSelect }: ParishOverviewProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {parishes
          .sort((a, b) => getMaxRiskLevel(b.riskProfile) - getMaxRiskLevel(a.riskProfile)) // Sort by risk level descending
          .map(parish => (
