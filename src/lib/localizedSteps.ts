      ...
      inputs: [
        {
          ...
          label: t('actionPlan.inputs.smartActionPlans.label'),
          prompt: t('actionPlan.inputs.smartActionPlans.prompt'),
          required: true,
          examples: [
            t('actionPlan.inputs.smartActionPlans.examples.0'),
            t('actionPlan.inputs.smartActionPlans.examples.1'),
            t('actionPlan.inputs.smartActionPlans.examples.2'),
          ],
        },
        {
          type: 'text',
          label: t('actionPlan.inputs.implementationPriority.label'),
          required: true,
          prompt: t('actionPlan.inputs.implementationPriority.prompt'),
          examples: [
            t('actionPlan.inputs.implementationPriority.examples.0'),
            t('actionPlan.inputs.implementationPriority.examples.1'),
            t('actionPlan.inputs.implementationPriority.examples.2'),
          ],
        },
        {
          type: 'text',
          label: t('actionPlan.inputs.budgetResources.label'),
          required: true,
          prompt: t('actionPlan.inputs.budgetResources.prompt'),
          examples: [
            t('actionPlan.inputs.budgetResources.examples.0'),
            t('actionPlan.inputs.budgetResources.examples.1'),
            t('actionPlan.inputs.budgetResources.examples.2'),
          ],
        },
        {
          type: 'text',
          label: t('actionPlan.inputs.implementationTeam.label'),
          required: true,
          prompt: t('actionPlan.inputs.implementationTeam.prompt'),
          examples: [
            t('actionPlan.inputs.implementationTeam.examples.0'),
            t('actionPlan.inputs.implementationTeam.examples.1'),
            t('actionPlan.inputs.implementationTeam.examples.2'),
          ],
        },
        {
          type: 'text',
