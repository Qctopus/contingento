  ...
  return {
    ...
    BUSINESS_OVERVIEW: {
      ...
      inputs: [
        ...
        {
          type: 'radio',
          label: t('businessOverview.inputs.approximateAnnualRevenue.label'),
          required: false,
          prompt: t('businessOverview.inputs.approximateAnnualRevenue.prompt'),
          options: [
            { label: t('businessOverview.inputs.approximateAnnualRevenue.options.0.label'), value: 'under_1m' },
            { label: t('businessOverview.inputs.approximateAnnualRevenue.options.1.label'), value: '1m_3m' },
            { label: t('businessOverview.inputs.approximateAnnualRevenue.options.2.label'), value: '3m_10m' },
            { label: t('businessOverview.inputs.approximateAnnualRevenue.options.3.label'), value: '10m_20m' },
            { label: t('businessOverview.inputs.approximateAnnualRevenue.options.4.label'), value: 'over_20m' },
            { label: t('businessOverview.inputs.approximateAnnualRevenue.options.5.label'), value: 'not_disclosed' },
          ],
        },
        {
          type: 'radio',
          label: t('businessOverview.inputs.totalPeopleInBusiness.label'),
          required: false,
          prompt: t('businessOverview.inputs.totalPeopleInBusiness.prompt'),
          options: [
            { label: t('businessOverview.inputs.totalPeopleInBusiness.options.0.label'), value: '1' },
            { label: t('businessOverview.inputs.totalPeopleInBusiness.options.1.label'), value: '2-5' },
            { label: t('businessOverview.inputs.totalPeopleInBusiness.options.2.label'), value: '6-10' },
            { label: t('businessOverview.inputs.totalPeopleInBusiness.options.3.label'), value: '11-25' },
            { label: t('businessOverview.inputs.totalPeopleInBusiness.options.4.label'), value: '26-50' },
            { label: t('businessOverview.inputs.totalPeopleInBusiness.options.5.label'), value: '50+' },
          ],
        },
        {
          type: 'radio',
          label: t('businessOverview.inputs.yearsInOperation.label'),
          required: false,
          prompt: t('businessOverview.inputs.yearsInOperation.prompt'),
          options: [
            { label: t('businessOverview.inputs.yearsInOperation.options.0.label'), value: '0-1' },
            { label: t('businessOverview.inputs.yearsInOperation.options.1.label'), value: '1-2' },
            { label: t('businessOverview.inputs.yearsInOperation.options.2.label'), value: '3-5' },
            { label: t('businessOverview.inputs.yearsInOperation.options.3.label'), value: '6-10' },
            { label: t('businessOverview.inputs.yearsInOperation.options.4.label'), value: '11-20' },
            { label: t('businessOverview.inputs.yearsInOperation.options.5.label'), value: '20+' },
          ],
        },
        {
          type: 'radio',
